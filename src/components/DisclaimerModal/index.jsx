        ...
        <div className={styles.content}>
          ...
          <div className={styles.text}>
            <p>
              ...
              <strong>informational and educational purposes only</strong>. A
              report does NOT constitute investment advice, a buy/sell
              recommendation, or an offer to buy/sell any security. Past
              performance does not guarantee future results. All trading
              involves risk; you may lose invested capital.
            </p>
            <p>
              The Elliott Wave methodology, Fibonacci retracement levels, and
              technical indicators are tools for analysis but not certainties.
              Fundamental assumptions (revenue growth rates, margin expansion,
              multiple re-rating, catalyst execution) are subject to change.
            </p>
            <p className={styles.highlight}>
              <strong>AI Hallucinations</strong> may be part of the reasoning
              process and create false assumptions, predictions and statements.
            </p>
          </div>
